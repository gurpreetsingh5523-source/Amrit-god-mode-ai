...
def __init__(
    self,
    bits: int = 3,
    method: str = "rotorquant",   # 'rotorquant' ਜਾਂ 'turboquant'
    protected_tokens: int = 128,  # ਪਹਿਲੇ N tokens FP16 ਵਿੱਚ
    verbose: bool = True
):
    self.bits = bits
    self.method = method
...
def compress(
    ...
    Returns:
        (compressed_keys, compressed_values) — decompress ਲਈ ਵਰਤੋ
    """
    ...
    # Protected tokens — compress ਨਾ ਕਰੋ
